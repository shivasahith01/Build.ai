...
export const RatePlanPage = lazy(() => import('src/pages/rate-plan'));
export const AnalyticsPage = lazy(() => import('src/pages/analytics'));
export const ChatbotPage = lazy(() => import('src/pages/chatbot'));
export const WholesalePage = lazy(() => import('src/pages/wholesale'));
  ...
  return useRoutes([
    {
      ...
      children: [
        ...
        { path: 'rate-plan', element: <RatePlanPage /> },
